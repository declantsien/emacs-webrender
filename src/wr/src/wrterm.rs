...
export_lisp_fns! {
    ...
    xw_color_values,
    x_register_dnd_atom,
    x_change_window_property,
    x_display_color_cells,
    x_display_planes,
    x_wm_set_size_hint,
    x_display_visual_class,
    x_display_monitor_attributes_list,
    x_display_pixel_width,
    x_display_pixel_height,
    x_own_selection_internal,
    x_get_selection_internal,
    x_selection_owner_p,
    x_selection_exists_p,
    x_frame_edges,
    wr_api_capture,
...
pub extern "C" fn syms_of_wrterm_rust() {
    syms_of_wrfont();
